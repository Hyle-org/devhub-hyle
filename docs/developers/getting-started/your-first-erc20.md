...
After Hylé verifies your proof, your transaction is settled, updating the state of the contract.
...
Finally, send the proof transaction to Hylé for verification and settlement.
